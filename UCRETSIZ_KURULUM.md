...
4. OpenRouter Keys ekranında eski uygulamaya yazılmış anahtarı sil ve yeni bir anahtar oluştur.
5. GitHub'a OPENROUTER_API_KEY adlı ikinci secret ekle.
6. GitHub'da Actions > Publish shared news feed > Run workflow düğmesine bas.
7. İşlem yeşil tamamlandığında https://gundemai.web.app/v1/news adresini aç. articles listesi görünüyorsa merkezi sistem çalışıyor.
